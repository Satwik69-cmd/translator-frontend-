...
import { ArrowRight, ChevronDown, Copy, FileText, GraduationCap, Languages, LanguagesIcon, MailOpen, Mic, PenBox, ScanSearchIcon, StarsIcon } from 'lucide-react';
  ...
  return (
    ...
    <h1 className='text-2xl font-bold bg-gradient-to-br from-green-600 to-green-400 bg-clip-text tracking-tighter text-transparent pr-2 pb-6'>
        <div className='flex gap-5'>
          ...
          <span className='text-4xl'>Audio Translate</span>
          <div className='ml-70'>
          <DropdownMenu >
