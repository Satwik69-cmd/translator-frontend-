      ...
      <div className='max-w mx-auto  p-4 bg-green-50 w-full sm:w-1/2  rounded-2xl transition-shadow duration-400  hover:shadow-[-7px_7px_0px_#50C878]'>
            ...
            <div className='flex gap-10'>
              <Link href={"/audiotranslation"}>
                <Button size="lg"  variant="outline" className="bg-green-600 hover:cursor-pointer text-white rounded-lg p-5 text-center">
                    <Mic/>Audio
                </Button>
              </Link>
              <Link href={"/visualtranslation"}>
                <Button size="lg"  variant="outline" className="bg-green-600 hover:cursor-pointer text-white rounded-lg py-5 text-center">
                    <ScanSearchIcon/>Scan
                </Button>
              </Link>
