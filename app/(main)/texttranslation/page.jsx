  ...
  return (
    <div className='max-w mx-auto  p-4 bg-green-50 w-full sm:w-1/2  rounded-2xl transition-shadow duration-400  hover:shadow-[-7px_7px_0px_#50C878]'>
          ...
          <div className='ml-70'>
            <DropdownMenu >
              <DropdownMenuTrigger asChild >
                <Button size="lg" variant="outline" className="bg-green-600 text-white hover:cursor-pointer rounded-lg p-5 text-center">
      ...
      <form action={async (formData) => {
        ...
        <Button type="submit" size="lg" variant="outline" className="bg-green-600 text-white hover:cursor-pointer rounded-lg p-5 text-center">
          <Languages /> Translate
        </Button>
        <Textarea
          className="my-10  border-green-600 border-2"
